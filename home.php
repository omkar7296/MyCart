...
if(isset($_SESSION['name'])){
	echo '<div id="hcart" style="float:left; margin-left:40px;">
		...
		<div id="hdiv3" style="float:left; margin-left:40px;">
...
<?php 
		while($i<=$rowcount1) :
				$row=mysqli_fetch_assoc($result1);?>
						...
						<div align="center" class="innerdivs" style="height:380px; width:320px; float:left; border:2px solid gray; margin-left: 7px; margin-bottom: 8px; border-radius: 8px;">
						<div id="container" style="text-align:center;  border-radius: 8px;"><img src="<?php echo 'images/'.$row['P_ID'].'.jpg'; ?>" height="300px" width="100%" align="center" style="border-radius: 8px;"></div><br><div id="pseudo">
