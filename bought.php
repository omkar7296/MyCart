...
@$id=$_SESSION['uid'];
$query="select * from bought where u_id='$id' ";
$i=1;
//$cost=0;
...
while($i<=$rowcount) :
				...
				<div style="height:550px; border: 5px solid gray; border-radius: 8px; padding: 5px; margin-bottom: 10px;">
				...
				<?php  $i++; endwhile; ?>
						<div style="width:500px; height:100px; margin-left:700px;">
						
						<a href="home.php?parameter=1" class="start">Continue Shopping</a></div></div><br><br>
</div><?php }
			else{
				echo '<div style="text-align:center; font-size:30px; color:#660066;">
					<strong>Sorry, you have no order history.... :-(</strong><br><br><br>
				</div>';
			}
			?>
